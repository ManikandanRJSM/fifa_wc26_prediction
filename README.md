...
pip install pyspark==4.1.1 delta-spark==4.1.0 pandas==2.3.3 requests==2.25.1 python-dotenv==1.2.2
```

**Dependencies:** Python > 3.9, OpenJDK > 17, Spark==4.1.1, pyspark==4.1.1, delta-spark==4.1.0, pandas==2.3.3, requests==2.25.1, python-dotenv==1.2.2, hadoop-aws 3.4.2
